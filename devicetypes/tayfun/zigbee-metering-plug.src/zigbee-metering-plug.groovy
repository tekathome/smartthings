...
metadata {
    definition (name: "Zigbee Metering Plug", namespace: "tayfun", author: "tayfun", ocfDeviceType: "oic.d.smartplug", mnmn: "SmartThings",  vid: "generic-switch-power-energy") {
        ...
        case "0702":
			...
			case "0400": // Power
                ...
                if (div != 0) {
                    ...
                    log.debug "XXX name=$name, value=$kw"
				}
            	break;
